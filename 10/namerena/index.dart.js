...
(function dartProgram() {
  ...
  function initializeDeferredHunk(a) {
    ...
    ms(a, b, c) {
      var s, r, q, p, o, n = Y.lC(a, b), m = new Q.dj(H.a([], t.i))
    ...
    mr(a, a0) {
      ...
      for (j = 0; j < o; ++j)for (m = 0; m < a0.length; ++m) {
        b = r[m]
        if (j < b.length) c.push(b[j])
      } for (j = 0; j < n; ++j)for (m = 0; m < a0.length; ++m) {
        b = q[m]
        if (j < b.length) c.push(b[j])
      } return c
    },
    ...
    mM(a, b) {
      ...
      if (1 <= b && b < 10) switch (a) {
        ...
        case 4: return 8
        case 8: return 8
        default: throw H.b(P.y("mode:" + a, s))
    ...
    mN(a) {
      ...
      for (s = 0, r = 0; r < f; ++r)for (q = 0; q < f; ++q) {
        p = a.u(r, q)
        for (o = 0, n = -1; n <= 1; ++n) {
          m = r + n
          if (m < 0 || f <= m) continue
      ...
      } for (m = f - 1, r = 0; r < m; r = i)for (i = r + 1, q = 0; q < m;) {
        h = a.u(r, q) ? 1 : 0
        if (a.u(i, q)) ++h; ++q
        if (a.u(r, q)) ++h
        if (a.u(i, q)) ++h
        if (h === 0 || h === 4) s += 3
      } for (m = f - 6, r = 0; r < f; ++r)for (q = 0; q < m; ++q)if (a.u(r, q) && !a.u(r, q + 1) && a.u(r, q + 2) && a.u(r, q + 3) && a.u(r, q + 4) && !a.u(r, q + 5) && a.u(r, q + 6)) s += 40
    ...
    kT(a) {
      var s, r, q, p, o, n, m = J.t(a), l = new Array(C.a.A(m.gh(a) * 8 + 14, 15))
      ...
      } if (r !== 15) if (r > 7) s[p] = (C.a.L(q, r - 8) & 127) + 13312
      else {
        q = C.a.L(q, r) & 32767
    ...
    kR(a) {
      var s, r, q, p, o, n, m, l = C.a.A(a.length * 15 + 7, 8), k = new Uint8Array(l)
    ...
    lL(a) {
      var s, r, q = J.t(a), p = new Array(q.gh(a) * 2 + 2)
    ...
    no() {
      var s, r, q, p, o, n, m, l, k, j, i, h, g = "none", f = ".checkBoss", e = ".loaderbg", d = "click"
    ...
    nl() {
      ...
      if (p != null && $.id.d != null && $.i8.d != null && p.d != null) {
        ...
        if ((window.localStorage.getItem(s) == null || C.a.n(window.localStorage.getItem(s).length, 100) !== 0) && $.i7.d != null) {
          window.localStorage.setItem(s, new H.c3(H.a($.i7.d.split(""), t.s), t.H).cZ(0))
        }
        
        // iH(a, b, c) { return J.a2(a).dr(a, b, c) },
        // J.ar.prototype.dr($.id.d, "[1,3,0,9]", J.aD($.hA))
        // dr(a, b, c) {
        //   P.ja(0, 0, a.length, "startIndex")
        //   return H.nG(a, b, c, 0)
        // },
        //   P.ja(0, 0, $.id.d.length, "startIndex")
        //   H.nG($.id.d, "[1,3,0,9]", J.p.prototype.j($.hA), 0)
        // j(a) { return P.hM(a, "[", "]") },
        //   P.ja(0, 0, $.id.d.length, "startIndex")
        //   H.nG($.id.d, "[1,3,0,9]", P.hM($.hA, "[", "]"), 0)
        // hM(a, b, c) { // Array to String
        //   var s, r
        //   if (P.i5(a)) return b + "..." + c // false
        //   s = new P.bh(b)
        //   $.aT.push(a)
        //   try {
        //     r = s
        //     r.a = P.jg(r.a, a, ", ")
        //   } finally { $.aT.pop() } s.a += c
        //   r = s.a
        //   return r.charCodeAt(0) == 0 ? r : r
        // },
        //   P.ja(0, 0, $.id.d.length, "startIndex") => do nothing
        //   H.nG($.id.d, "[1,3,0,9]", $.hA.toString, 0)
        // ja(a, b, c, d) {
    ...
    lq(a, b, c) {
      var s, r, q, p, o, n, m, l, k, j, i, h, g, f = b.length, e = a.$R
      ...
      if (r) {
        ...
        l = P.af(b, !0, t.z)
        k = Object.keys(q)
        if (c == null) for (r = k.length, j = 0; j < k.length; k.length === r || (0, H.bz)(k), ++j) {
          i = q[k[j]]
    ...
    n_(a) {
      ...
      if ("number" in a && typeof a.number == "number") {
        ...
        if ((C.a.O(r, 16) & 8191) === 10) switch (q) {
          case 438: return H.aC(a, H.hO(H.d(s) + " (Error " + q + ")", e))
      ...
      } if (typeof InternalError == "function" && a instanceof InternalError) if (typeof s == "string" && s === "too much recursion") return new P.c5()
      return a
    },
    am(a) {
      var s
    ...
    kZ(a, b, c) {
      ...
      if (typeof a == "string") {
        ...
        return function (d, e) { return function () { return e(this, d) } }(a, H.kV)
    ...
    l0(a, b, c, d) {
      var s = H.iM, r = H.kW
      switch (b ? -1 : a) {
        case 0: throw H.b(new H.dp("Intercepted function with no arguments."))
    ...
    kW(a) { return a.b },
    em(a) {
      var s, r, q, p = new H.aZ("receiver", "interceptor"), o = J.j0(Object.getOwnPropertyNames(p))
    ...
    cy(a, b, c, d) {
      var s, r, q, p, o = b.length, n = H.h3(o)
      for (s = !1, r = 0; r < o; ++r) {
        q = b[r]
        p = H.az(a, q, c, d)
        if (p !== q) s = !0
    ...
    mY(a, b, c, d) {
      var s, r, q, p, o, n, m = b.length, l = H.h3(m)
      for (s = !1, r = 0; r < m; r += 3) {
        q = b[r]
        p = b[r + 1]
        o = b[r + 2]
    ...
    mX(a, b, c, d) {
      var s, r = b.a, q = H.cy(a, r, c, d), p = b.b, o = H.cy(a, p, c, d), n = b.c, m = H.mY(a, n, c, d)
    ...
    jQ(a, b) {
      var s
      if (H.jf(b)) if (a instanceof H.aG) {
        s = H.n7(a)
        if (s != null) return s
      } return H.Z(a)
    },
    ...
    mD(a, b) {
      var s = a instanceof H.aG ? a.__proto__.__proto__.constructor : b, r = H.mf(v.typeUniverse, s.name)
      b.$ccache = r
      return r
    },
    nd(a) {
    ...
    jn(a, b, c) {
      var s = P.b4(a), r = H.U(b == null ? H.Z(a) : b, null)
    ...
    ju(a, b, c) {
      var s, r, q, p, o, n = b.cy, m = c.a, l = m.length, k = c.b, j = k.length, i = c.c, h = i.length, g = "(" + H.e3(m)
      if (j > 0) {
        s = l > 0 ? "," : ""
        r = H.e3(k)
        g += s + "[" + r + "]"
    ...
    hV(a, b, c, d) {
      var s, r = b.cy + ("<" + H.e3(c) + ">"), q = a.eC.get(r)
      if (q != null) return q
      s = H.m8(a, b, c, r, d)
      a.eC.set(r, s)
      return s
    ...
    nJ(a) { return H.D(new H.d0("Field '" + H.d(a) + "' has been assigned during initialization.")) }
  }, J = {
    ih(a, b, c, d) { return { i: a, p: b, e: c, x: d } },
    hl(a) {
      var s, r, q, p, o, n = a[v.dispatchPropertyName]
      if (n == null) if ($.ic == null) {
        H.nh()
    ...
    ao(a, b) {
      if (typeof b === "number") if (a.constructor == Array || typeof a == "string" || H.jS(a, a[v.dispatchPropertyName])) if (b >>> 0 === b && b < a.length) return a[b]
      return J.t(a).i(a, b)
    },
    hE(a, b, c) {
      if (typeof b === "number") if ((a.constructor == Array || H.jS(a, a[v.dispatchPropertyName])) && !a.immutable$list && b >>> 0 === b && b < a.length) return a[b] = c
    ...
    l7(a, b) {
      var s, r, q, p, o, n = b.d === 1, m = C.f.ga1().I(a), l = n ? O.lN(a) : null, k = m.length
      b.a = 0
      if (b.d === 1) {
        b.d = 0
        if (k > 16 && l.length > 16) {
    ...
    iX(a, b, c) {
      var s, r, q = a.length, p = C.h.p(a, 0, q - C.w[b.c]), o = b.c
      if (o === 3) {
        s = H.a([a[q - 2]], t.i)
        C.c.D(s, C.f.ga1().I(c))
        r = new Y.ag()
    ...
    lN(a) {
      var s, r, q, p, o = new Uint8Array(a.length * 2), n = new H.ap(a)
    ...
    mp(a, b) {
      var s, r, q = new P.h6(b), p = new P.h7(b)
    ...
    cd(a, b) {
      ...
      for (s = t.c; !0;) {
        ...
        if (k) {
          ...
          if (q) {
            h = r.a.b
            if (e instanceof P.v) if ((e.a & 24) !== 0) {
              g = h.c
              h.c = null
              b = h.an(g)
              h.a = e.a & 30 | h.a & 1
    ...
    lX(a, b, c, d, e, f) {
      var s, r, q, p, o, n, m = "Invalid encoding before padding", l = "Invalid character", k = C.a.O(f, 2), j = f & 3, i = $.kA()
      for (s = b, r = 0; s < c; ++s) {
        q = C.b.q(a, s)
        r |= q
        p = i[q & 127]
    ...
    lV(a, b, c, d) {
      var s = P.lW(a, b, c), r = (d & 3) + (s - b), q = C.a.O(r, 2) * 3, p = r & 3
      if (p !== 0 && s < c) q += p - 1
    ...
    bu: function bu() { },
    nA(a, b) {
      var s = new P.v($.q, b.k("v<0>")), r = new P.ca(s, b.k("ca<0>"))
    ...
    lI(a, b) {
      var s, r, q, p, o, n = b[0], m = b[1], l = J.t(a), k = C.a.A(l.gh(a) * 8 + 2, 3)
      if (J.a3(l.ga6(a), m)) {
        a = l.p(a, 0, l.gh(a) - 1)
      ...
      } if (m >= 0) for (; r < 3;) { q = (q << 1 | 1) >>> 0; ++r } if (r > 0) s[p] = C.k[C.a.L(q, 3 - r) & 7]
      return P.au(s, 0, null)
    },
    lH(a, b) {
      var s, r, q, p, o, n, m, l = b[0], k = b[1], j = C.a.A(a.length * 3 + 7, 8), i = new Uint8Array(j)
    ...
    f6: function f6() { }
  }, V = { dk: function dk(a) { this.b = a }, eC: function eC(a) { this.c = a } }, W = {
    iK(a, b) {
      var s = {}
      s.type = b
    ...
    jo(a) {
      var s = document.createElement("a"), r = new W.fQ(s, window.location)
      r = new W.bt(r)
      r.c_(a)
      return r
    },
    ...
    jt() {
      var s = t.N, r = P.j4(C.y, s), q = H.a(["TEMPLATE"], t.s)
    ...
    kU(a) {
      var s, r, q, p, o, n, m = J.t(a), l = m.gh(a), k = P.ba(C.j.bo(l * 8 / 6.5), 0, !0, t.e)
    ...
    iJ(a, b) {
      var s, r, q, p, o, n, m, l, k = a.length, j = P.ba(C.j.bo(k * 7 / 8), 0, !0, t.e)
    ...
    lC(a, b) {
      var s, r, q, p, o, n, m = Y.mA(a, b), l = m.length / 3 | 0, k = H.a([], t.r)
      for (s = 0; s < l; ++s) {
        r = s * 3
        q = m[r]
        p = m[r + 1]
  ...
  H.c7.prototype = {
    gc9() {
      var s = J.H(this.a), r = this.c
      if (r == null || r > s) return s
      return r
    },
    gcq() {
      var s = J.H(this.a), r = this.b
      if (r > s) return s
      return r
    },
    gh(a) {
      var s, r = J.H(this.a), q = this.b
      if (q >= r) return 0
      s = this.c
    ...
    C(a, b) {
      var s = this, r = s.gcq() + b
      if (b < 0 || r >= s.gc9()) throw H.b(P.bN(b, s, "index", null, null))
      return J.iC(s.a, r)
    },
    al(a, b) {
      var s, r, q, p = this, o = p.b, n = p.a, m = J.t(n), l = m.gh(n), k = p.c
      if (k != null && k < l) l = k
      s = l - o
      if (s <= 0) {
        n = J.iZ(0, p.$ti.c)
  ...
  H.a5.prototype = {
    gt() { return this.d },
    l() {
      var s, r = this, q = r.a, p = J.t(q), o = p.gh(q)
  ...
  P.v.prototype = {
    ...
    b5(a) {
      var s, r, q, p = this
      p.a ^= 2
      try { a.aW(new P.fA(p), new P.fB(p), t.P) } catch (q) {
        s = H.x(q)
        r = H.am(q)
        P.nC(new P.fC(p, s, r))
      }
  ...
  P.fr.prototype = {
    cL(a, b, c, d) {
      var s, r = this.a, q = (r & 3) + (c - b), p = C.a.A(q, 3), o = p * 4
      if (q - p * 3 > 0) o += 4
      s = new Uint8Array(o)
  ...
  P.fj.prototype = {
    I(a) {
      var s, r, q = P.a0(0, null, a.length), p = q - 0
  ...
  P.fg.prototype = {
    I(a) {
      var s = this.a, r = P.lP(s, a, 0, null)
      if (r != null) return r
  ...
  P.h1.prototype = {
    cF(a, b, c, d) {
      var s, r, q, p, o, n = this, m = P.a0(b, c, J.H(a))
      if (b === m) return ""
      if (t.bX.b(a)) {
        s = a
        r = 0
    ...
    cJ(a, b, c, d) {
      var s, r, q, p, o, n, m, l = this, k = 65533, j = l.b, i = l.c, h = new P.bh(""), g = b + 1, f = a[b]
      $label0$0: for (s = l.a; !0;) {
        ...
        if (f < 128) {
          ...
          } if (o - g < 20) for (m = g; m < o; ++m)h.a += H.bd(a[m])
          else h.a += P.au(a, g, o)
          if (o === c) break $label0$0
          g = p
        } else g = p
      } if (d && j > 32) if (s) h.a += H.bd(k)
      else {
        l.b = 77
        l.c = c
        return ""
  ...
  P.b2.prototype = {
    ...
    j(a) {
      var s = this, r = P.l3(H.lz(s)), q = P.cO(H.lx(s)), p = P.cO(H.lt(s)), o = P.cO(H.lu(s)), n = P.cO(H.lw(s)), m = P.cO(H.ly(s)), l = P.l4(H.lv(s))
  ...
  P.a_.prototype = {
    ...
    gaA() { return "" },
    j(a) {
      var s, r, q = this, p = q.c, o = p == null ? "" : " (" + p + ")", n = q.d, m = n == null ? "" : ": " + H.d(n), l = q.gaB() + o + m
      if (!q.a) return l
      s = q.gaA()
      r = P.b4(q.b)
      return l + s + ": " + r
  ...
  P.dc.prototype = {
    j(a) {
      var s, r, q, p, o, n, m, l, k = this, j = {}, i = new P.bh("")
      j.a = ""
      s = k.c
  ...
  P.ey.prototype = {
    j(a) {
      var s, r, q, p, o, n, m, l, k, j, i, h, g = this.a, f = "" !== g ? "FormatException: " + g : "FormatException", e = this.c, d = this.b
      if (typeof d == "string") {
  ...
  P.fe.prototype = {
    $2(a, b) {
      var s, r, q, p = J.iE(b, "=")
      if (p === -1) { if (b !== "") J.hE(a, P.hX(b, 0, b.length, this.a, !0), "") } else if (p !== 0) {
        s = C.b.S(b, 0, p)
        r = C.b.M(b, p + 1)
        q = this.a
  ...
  W.cb.prototype = {
    ...
    P(a, b) {
      var s = "data-" + this.a9(b), r = this.a.a, q = r.getAttribute(s)
      r.removeAttribute(s)
      return q
    },
  ...
  W.e5.prototype = {
    ...
    ck(a, b) {
      ...
      } catch (p) { H.x(p) } r = "element unprintable"
      try { r = J.aD(a) } catch (p) { H.x(p) } try {
        q = W.bH(a)
  ...
  P.fU.prototype = {
    ...
    cG(a, b) {
      var s, r = J.t(a), q = r.gh(a), p = new Array(q)
      this.b[b] = p
  ...
  P.h9.prototype = {
    $1(a) {
      var s = function (b, c, d) { return function () { return b(c, d, this, Array.prototype.slice.apply(arguments)) } }(P.mq, a, !1)
      P.i0(s, $.hB(), a)
      return s
    },
    $S: 5
  ...
  P.W.prototype = {
    ...
    aj(a, b) {
      var s = this.a, r = b == null ? null : P.hP(new H.F(b, P.nn(), H.aj(b).k("F<1,@>")), t.z)
  ...
  Y.ag.prototype = {
    ...
    ak(a) {
      var s, r, q, p, o, n = this, m = J.t(a), l = m.gh(a)
      for (s = 0; s < l; ++s) {
        r = n.a = n.a + 1 & 255
        q = n.b
        p = n.c
  ...
  N.f0.prototype = {
    dG(a, b, c) {
      ...
      try {
        ...
        J.iD(n, 0, 0, p, p)
        n.fillStyle = "#000"
        for (m = 0; m < r; ++m)for (l = 0; l < r; ++l)if (o.u(m, l)) J.iD(n, l * q, m * q, q, q)
      } catch (f) {
        H.x(f)
        k = H.am(f)
        j = e.a
  ...
  G.cY.prototype = {
    bY(a, b) {
      var s, r = this, q = $.ea(), p = r.a, o = t.W.a(q.i(0, p))
      r.b = o
  ...
  G.d3.prototype = {
    bA(a, b) {
      var s, r, q = this, p = window.location.hash
      if (p == q.id) return
      q.id = p
      if (p.length > 1) {
        s = P.lO(J.ee(p, 1))
    ...
    aU(a) {
      var s = this, r = J.ef(s.d.value), q = $.is(), p = H.aW(r, q, "")
    ...
    bz(a) {
      var s = this, r = a == null || C.b.R(s.ch.style.height, "0"), q = s.cx
      if (r) {
    ...
    df(a, b) {
      var s, r, q, p = this, o = "button", n = t.S
  ...
  G.eR.prototype = {
    $1(a) {
      var s = J.aX(a, new G.eQ(), t.X), r = P.af(s, !0, s.$ti.k("C.E"))
      if (r.length > 1) {
        this.a.a = !0
        return C.c.a2(r, "\n")
  ...
  Q.dj.prototype = {
    ...
    bG(a) {
      var s = this, r = C.a.A(s.b, 8), q = s.a
  ...
  D.f2.prototype = {
    gh(a) { return this.a.length },
    d1(a) {
      var s, r, q, p, o, n, m, l = this.a, k = l.length, j = a.a, i = j.length, h = new Uint8Array(k + i - 1)
      for (s = 0; s < k; ++s)for (r = 0; r < i; ++r) {
        q = s + r
        p = h[q]
        o = l[s]
    ...
    bx(a) {
      var s, r, q, p = this.a, o = p.length, n = a.a, m = n.length
  ...
  D.f1.prototype = {
    ...
    cm() {
      ...
      for (s = e.length, r = this.d, q = 0; q < s; ++q)for (p = 0; p < s; ++p) {
        o = e[q]
        n = e[p]
        if (r[o][n] != null) continue
        for (m = -2; m <= 2; ++m)for (l = o + m, k = m !== -2, j = m !== 2, i = m === 0, h = -2; h <= 2; ++h) {
    ...
    ce(a, b) {
      var s, r, q, p, o, n, m, l, k, j = this.c, i = j - 1
  ...
  Y.dm.prototype = {}; (function aliases() {
    var s = J.I.prototype
    s.bN = s.j
    s.bM = s.aq
    s = J.as.prototype
    ...
    var s = hunkHelpers._static_1, r = hunkHelpers._static_0, q = hunkHelpers.installStaticTearOff, p = hunkHelpers._instance_1u, o = hunkHelpers._instance_1i
    s(P, "n2", "lS", 4)
    s(P, "n3", "lT", 4)
    s(P, "n4", "lU", 4)
    r(P, "jL", "mW", 0)
